...
export default function Header() {
  return (
    <div className="px-[6.25rem] bg-[url('/image/bg-header.png')] bg-no-repeat bg-cover bg-bottom">
      ...
      <h1
        data-aos="fade-up"
        className="text-white font-anton text-[4.6875rem] leading-[6.5625rem] w-full max-w-[50.25rem] pt-[13.94rem] mb-[8.94rem]"
      >
      ...
      <div className="flex justify-between pb-[4.31rem]">
        <div
          data-aos="fade-up"
          className="w-full max-w-[37.3125rem] relative bottom-0 flex flex-col justify-end"
        >
          ...
          <div
            data-aos="fade-up"
            className="text-white font-sans text-[1.25rem] leading-[1.5rem]"
          >
        ...
        <div>
          <div className="grid grid-cols-2 gap-4 mb-[1.87rem]">
            <div>
              <div
                data-aos="fade-up"
                className="text-white uppercase font-anton text-[0.875rem] leading-[1.375rem] opacity-65"
              >
                Khách hàng
              </div>
              <div
                data-aos="fade-up"
                className="text-white font-medium font-sans text-[1.25rem] leading-[1.65625rem] py-[0.5rem]"
              >
                Công ty dầu khí PSD
              </div>
            </div>
            <div className="ml-[7.19rem]">
              ...
              <div
                data-aos="fade-up"
                className="text-white font-medium font-sans text-[1.25rem] leading-[1.65625rem]"
              >
                Development
              </div>
            </div>
