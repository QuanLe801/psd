...
export default function Produce() {
  ...
  return (
    <div className="flex bg-bottom bg-[url('/produce.png')] py-[11.88rem]">
      <div className=" pl-[6.25rem] w-full max-w-[46.0575rem] pr-[5.62rem]">
        <div className="font-anton text-[3.375rem] leading-[4.725rem] uppercase text-white mb-8">
          ngành hàng kinh doanh
        </div>
        <div className="font-sans text-2xl leading-[2.55rem] lowercase text-white">
      ...
      <div className={`w-[calc(100vw-46.0575rem)]`}>
        <Swiper spaceBetween={50} slidesPerView={1.3} loop>
